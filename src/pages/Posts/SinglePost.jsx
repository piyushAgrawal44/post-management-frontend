            ...
            <div className="mb-6">
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold mr-3">
                  {state?.userId?.emailOrUserName?.charAt(0).toUpperCase() || "U"}
                </div>
                <div>
              ...
              <div className="prose max-w-none text-gray-700">
                <p className="text-lg leading-relaxed whitespace-pre-wrap">{state?.content}</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-100">
              <div className="flex space-x-4 text-sm text-gray-500">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">{state?.comments || 0} comments</span>
                </div>
              </div>
              {state?.tags && (
            ...
            <form onSubmit={commentHandler}>
              ...
              <div className="flex justify-end mt-4">
                <button
                  ...
                  className={`bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-6 rounded-lg transition-all duration-200 flex items-center gap-2 ${isSubmitting || !comment.trim() ? "opacity-60 cursor-not-allowed" : ""
                    }`}
                >
                  {isSubmitting ? (
                    <>
